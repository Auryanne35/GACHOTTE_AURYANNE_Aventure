...
if(O_manager_touche.ouverture_inventaire == true){	/// @DnDAction : YoYo Games.Drawing.Draw_Sprite
	...
	{
		draw_sprite(S_oeuil_kraken_inventaire,0,1168,794);
