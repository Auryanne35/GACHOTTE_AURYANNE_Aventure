...
if (detection){
	...
	if (dirX ==0 and dirY == 0){
		...
		{
			sprite_index = ennemi_idle_droit;
		}
		else if (attaque_possible_gauche)
		{
			sprite_index = ennemi_idle_gauche;
		}
		else if (attaque_possible_bas)
		{
			sprite_index = ennemi_idle_bas;
		}
		else if (attaque_possible_haut)
		{
			sprite_index = ennemi_idle_haut;
		}	
	...
	if (attaque_possible_bas){
		show_debug_message("attaque en bas")
